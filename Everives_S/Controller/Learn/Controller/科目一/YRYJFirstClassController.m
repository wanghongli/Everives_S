...
-(void)setMiddleViewMsg
{
    ...
    NSArray *sxPractice = [YRFMDBObj getPracticeWithType:0 withSearchMsg:@"already = 1" withFMDB:[YRFMDBObj initFmdb]];
    NSArray *sjPractice = [YRFMDBObj getPracticeWithType:0 withSearchMsg:@"randomAlready = 1" withFMDB:[YRFMDBObj initFmdb]];
    NSArray *ztPractice = [YRFMDBObj getPracticeWithType:0 withSearchMsg:@"professionalAlready = 1" withFMDB:[YRFMDBObj initFmdb]];
    NSArray *allPractice = [YRFMDBObj getShunXuPracticeWithType:0 withFMDB:[YRFMDBObj initFmdb]];
