...
- (void)viewDidLoad
{
    ...
    self.msgLabel.font = kFontOfSize(15.0f);
...
- (void)setupAssets:(voidBlock)successBlock
{
    ...
    self.labelSelectedMedia.font = kFontOfSize(18.0f);
    if (!self.assets)
...
- (void)initNoAssetView
{
    ...
    self.btnClose.titleLabel.font = kFontOfSize(15.0f);
    self.labelSelectedMedia.font = kFontOfSize(18.0f);
    self.noticeLabel.font = kFontOfSize(16.0f);
    self.selectedCountBtn.titleLabel.font = kFontOfSize(14.0f);
    self.switchBtn.titleLabel.font = kFontOfSize(15.0f);
    ...
    self.btnDone.titleLabel.font = kFontOfSize(15.0f);
