...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        // Initialization code
        self.textLabel.font = kFontOfSize(17.f);//[UIFont fontWithName:@"AppleSDGothicNeo-Medium" size:17];
        self.detailTextLabel.font = kFontOfSize(11.0f);//[UIFont fontWithName:@"AppleSDGothicNeo-Medium" size:11];
